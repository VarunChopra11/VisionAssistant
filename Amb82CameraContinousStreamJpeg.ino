// Upload The following Code in Amb82-mini IOT Camera Module using Arduino IDE.
...
void setup() {
    ...
    while (status != WL_CONNECTED) {
        ...
        // status = WiFi.apbegin("AmebaVideoAP", "1");  //Remove this line from comments to make Amb82 camera module work as a router.
        delay(5000);
    }
